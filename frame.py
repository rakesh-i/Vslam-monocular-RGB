...
from constants import RANSAC_RESIDUAL_THRES, RANSAC_MAX_TRIALS # fit a linear model
...
def match_frames(f1, f2):
  ...
  # Lowe's ratio test to get correspondence between 2 features
  ret = []
  idx1, idx2 = [], []
  idx1s, idx2s = set(), set()
...
class Frame(object):
  ...
  # inverse of intrinsics matrix to perform transformation of 3D coordinates to 2D
  @property
  def Kinv(self):
  ...
  # normalized keypoints (placing in a maximum or minimum range)
  @property
  def kps(self):
